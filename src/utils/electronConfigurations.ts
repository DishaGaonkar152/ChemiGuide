// Correct electron shell configurations for all 118 elements
// Each array represents electrons per principal energy level: [K, L, M, N, O, P, Q]
// Based on Aufbau principle with known exceptions (Cr, Cu, Pd, etc.)

export const ELECTRON_SHELL_CONFIG: Record<number, number[]> = {
  1: [1],
  2: [2],
  3: [2, 1],
  4: [2, 2],
